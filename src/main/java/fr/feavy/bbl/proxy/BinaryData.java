...
import fr.feavy.bbl.proxy.ByteArray;
...
public class BinaryData extends ByteArray {
    ...
    public BinaryData(int[] data, int bitPosition, int length) {
        super(data);
    ...
    public BinaryData bitReadBinaryData() {
        float loc1 = this.bitReadUnsignedInt(16);
        return this.bitReadBinary(loc1);
    }

    public BinaryData bitReadBinary(float loc1) {
        int loc5 = 0;
        BinaryData loc2 = new BinaryData();
    ...
    public void bitWriteBinaryData(BinaryData param1) {
        int loc2 = Math.min(param1.bitLength, powList.get(16) - 1);
        this.bitWriteUnsignedInt(16, loc2);
        this.bitWriteBinary(param1);
    }

    public void bitWriteBinary(BinaryData param1) {
        int loc3 = 0;
        int loc4 = 0;
